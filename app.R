...
ui <- fluidPage(navbarPage(
           ...
           sidebarLayout(
             sidebarPanel(
               ...
               sliderInput(
                 ...
                 value = c(as.Date("2020-02-25"), as.Date("2020-04-21")),
                 timeFormat = "%Y-%m-%d"
               )
             ),
  ...
  tabPanel("About the tool",
           mainPanel(
             ...
             p("- ",strong("New cases variation (+%): "),"It is similar to the previous plot. It displays the percertange of new infections with respect to the previous day against the date. The percertange is plotted in the y axis and the date, again, in the x axis. The percertange represented is the percertange difference between the new cases of one date and the previous one. The following table offers an example."),
             tableOutput('tbl'),
